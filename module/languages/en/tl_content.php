 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_content']['twitter_connect_api_key']     = array(
	'API key',
	'Please enter the key of your twitter app.'
);
$GLOBALS['TL_LANG']['tl_content']['twitter_connect_api_secret']  = array(
	'API Secret',
	'Please enter the secret of your twitter app.'
);
$GLOBALS['TL_LANG']['tl_content']['twitter_connect_access_type'] = array(
	'Access type',
	'Please choose the access type.'
);
$GLOBALS['TL_LANG']['tl_content']['twitter_connect_groups']      = array(
	'Groups',
	'Please chose the groups, new members will be assigned too.'
);
$GLOBALS['TL_LANG']['tl_content']['twitter_connect_jumpTo']      = array(
	'Redirect page',
	'Please choose the page to which visitors will be redirected after successful log-in.'
);
$GLOBALS['TL_LANG']['tl_content']['twitter_activation_required']      = array(
 ...
 * References
 */
$GLOBALS['TL_LANG']['tl_content']['twitter_connect_access_types']['read']  = 'Read';
$GLOBALS['TL_LANG']['tl_content']['twitter_connect_access_types']['write'] = 'Read and Write';
